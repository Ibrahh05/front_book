    ...
    <div class="card register-card p-4">
        ...
        <form action="<?php echo e(route('register.submit')); ?>" method="POST">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">¿Ya tienes cuenta? Entra aquí</a>
            </div>
        </form>
    </div>
</body>
</html><?php /**PATH C:\Users\Ibra\Desktop\2º DAW\Desarrollo web en entorno servidor (8)\Trabajo-subir-nota\front_book\resources\views/auth/register.blade.php ENDPATH**/ ?>