...
<div class="container mt-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('watches.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="form-row">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ibra\Desktop\2º DAW\Desarrollo web en entorno servidor (8)\Trabajo-subir-nota\front_book\resources\views/watches/create.blade.php ENDPATH**/ ?>